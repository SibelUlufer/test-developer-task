    ...
    return (
      <MDBContainer>
        <form className="needs-validation" onSubmit={this.submitHandler}>
          <MDBRow>
            <MDBCol md="4" className="mb-3">
              ...
              />
              <div className="invalid-feedback" testid="invalid-feedback" >Incorrect format</div>
              <div className="valid-feedback" testid="valid-feedback" >Correct format</div>
            </MDBCol>
            <MDBCol md="4" className="mb-3">
              <br />
        ...
        >
          ...
          <MDBModalBody>
            Asset name should be unique. Asset with this name already exists
          </MDBModalBody>
          <MDBModalFooter>
